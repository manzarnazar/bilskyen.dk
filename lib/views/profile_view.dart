...
class ProfileView extends StatelessWidget {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Profile Card
                      _buildProfileCard(isDark, currentUser),
                      const SizedBox(height: 24),
                      // Account Settings
  ...
  Widget _buildProfileCard(bool isDark, UserModel? currentUser) {
    ...
    // Get user name
    String getUserName() {
      if (currentUser == null) return 'Guest User';
      return currentUser.name;
    }

    // Get user email
    String getUserEmail() {
      if (currentUser == null) return 'No email';
    ...
    bool isEmailVerified() {
      ...
      return currentUser.emailVerifiedAt != null;
    }
